...
public class SiteJobExtensionController {
    ...
    public ResponseEntity<ApiResponse<String>> getWizard(@AdminSitePathId Long id) {
    ...
    public ResponseEntity<ApiResponse<List<SiteAdvanceExpenseLineDto>>> getAdvanceLines(@AdminSitePathId Long id) {
    ...
    public ResponseEntity<ApiResponse<List<SiteTechnicianDailyPaymentDto>>> getTechnicianPayments(@AdminSitePathId Long id) {
    ...
    public ResponseEntity<ApiResponse<List<SiteToolIssueDto>>> getToolIssues(@AdminSitePathId Long id) {
    ...
    public ResponseEntity<ApiResponse<String>> getBehaviour(@AdminSitePathId Long id) {
    ...
    public ResponseEntity<ApiResponse<List<SiteChallengeLineDto>>> getChallenges(@AdminSitePathId Long id) {
    ...
    public ResponseEntity<ApiResponse<FeedbackInviteResponse>> createFeedbackInvite(@AdminSitePathId Long id) {
